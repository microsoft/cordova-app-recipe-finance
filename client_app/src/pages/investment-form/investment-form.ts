...
export class InvestmentForm {
    ...
    ionViewDidEnter() {
        console.log('Investment Form: Entering ionViewDidEnter');
    ...
    save() {
        ...
        if (this.investmentForm.valid) {
            ...
            if (this.investmentForm.controls['purchasePrice'].invalid) fldLst.push('Purcahse Price');
            ...
            let alert = this.alertController.create({
                ...
                message: `One or more required fields are missing value(s). <br /><br />Please check the values for the following field(s): <strong>${res}</strong>.`,
