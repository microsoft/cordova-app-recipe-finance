...
export class ClientDataStorage {
    ...
    public deleteClient(idx: Number): Promise<any> {
        console.log('ClientDataStorage: deleteClient()');
        //todo: Delete associated accounts when you delete a client
        console.debug('Todo: Delete associated accounts when you delete a client');
    ...
    private importData(ref: string): Promise<any> {
    ...
    public deleteAccount(idx: Number): Promise<any> {
        console.log('ClientDataStorage: deleteAccount()');
        //todo: Delete associated investments when you delete an account
        console.debug('Todo: Delete associated investments when you delete an account');
    ...
    public getAccounts(clientIdx: Number): Promise<any[]> {
    ...
    public deleteInvestment(idx: Number): Promise<any> {
    ...
    public getInvestments(accountId: String): Promise<any[]> {
        ...
        return new Promise(resolve => {
            ...
            if (this.investments.length > 0) {
                ...
                console.log('ClientDataStorage: Reading investment list from storage');
